...
buildIndex()
  .then((n) => console.log(`[secure] ${n} doküman indekslendi`))
  .catch((e) => console.error(`[secure] indeks kurulamadı: ${e.message}`))
  .finally(() => server.listen(port, () => console.log(`[secure] http://localhost:${port}`)));
